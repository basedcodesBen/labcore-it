...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-bold mb-4">Create New Room</h1>
    ...
    <form action="{{ route('admin.rooms.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="capacity" name="capacity" required class="form-input mt-1 block w-full p-2.5 rounded-lg border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
        ...
        <div class="mb-6 flex justify-end">
            <button type="submit" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">
                <i class="fa fa-save mr-2"></i> Create Room
            </button>
        </div>
        <div class="mb-4">
